...
public class Reader {
     ...
     *
     * @param location The location were the data should be stored, e.g.
     ...
     *
     * @param arrayList data which should be saved
     * @throws IOException
     */
     ...
     * by comma
     *
     * @param arrayList the input, which should be saved
     * @param location  the location, where the data should be stored
     * @throws IOException
     */
     ...
     *
     * @param location the location, from where the data should be read
     ...
     *
     * @param location location from which the data should be read
     ...
     *
     * @param location were the content should be deleted
     */
